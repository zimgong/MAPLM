# This is a modified version of the original CLIP model from Hugging Face Transformers library.
# Original author: OpenAI
# Original model: https://huggingface.co/openai/clip
# Modifications by: Zim Gong
